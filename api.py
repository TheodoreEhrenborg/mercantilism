...
#        self.should_quit = True
    ...
    def check_for_processes(self):
        ...
        os.system("top -stats command -l 1 > Results/top-output.txt")
                ...
                if a != b:
                    ...
                    for line in lines:
                        ...
                        if key in line:
                            ...
                            found = True
                            break
                    # (confidence, num_trials, total_time,sum_trials)
...
#                checked_in_log.append( current_pair )
            ...
            LIMIT = 20
            TIME_LIMIT = 25 * 60
            # After LIMIT games, the computer must stop to check probabilities.
            game_count = 0
